...
- **Tenant-scoped deletes**: a tombstone names the tenant that issued it and never hides, rewrites or compacts away another tenant's rows; each tenant lists and un-deletes only its own.
