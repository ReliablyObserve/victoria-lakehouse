...
// verification-gap list, then every feature grouped by area. outDir is the
// directory the document will be written to (FeaturesDocDir in production),
// which decides how in-repo Markdown links are rewritten.
func RenderFeatures(set *registry.FeatureSet, reg *registry.Registry, outDir string) string {
