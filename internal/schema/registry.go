...
var LogsProfile = Profile{
	Promoted: []FieldMapping{
		...
		{ParquetColumn: "span_id", InternalName: "span_id", Type: TypeString, Origin: OriginPromoted, HasBloom: true},
		{ParquetColumn: "k8s.deployment.name", InternalName: "k8s.deployment.name", Type: TypeString, Origin: OriginPromoted},
		{ParquetColumn: "k8s.node.name", InternalName: "k8s.node.name", Type: TypeString, Origin: OriginPromoted, HasBloom: true},
...
var TracesProfile = Profile{
	Promoted: []FieldMapping{
		...
		{ParquetColumn: "host.name", InternalName: "resource_attr:host.name", Type: TypeString, Origin: OriginPromoted, HasBloom: true},
		{ParquetColumn: "k8s.namespace.name", InternalName: "resource_attr:k8s.namespace.name", Type: TypeString, Origin: OriginPromoted},
		{ParquetColumn: "k8s.pod.name", InternalName: "resource_attr:k8s.pod.name", Type: TypeString, Origin: OriginPromoted, HasBloom: true},
		{ParquetColumn: "k8s.deployment.name", InternalName: "resource_attr:k8s.deployment.name", Type: TypeString, Origin: OriginPromoted},
		{ParquetColumn: "k8s.node.name", InternalName: "resource_attr:k8s.node.name", Type: TypeString, Origin: OriginPromoted, HasBloom: true},
