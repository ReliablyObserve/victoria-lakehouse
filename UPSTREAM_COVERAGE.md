...
| `/delete/active_tasks` | `app/vlselect/main.go` | vl.delete.active_tasks.status | 🟡 declared, not yet executed |
| `/delete/active_tasks` | `app/vtselect/logsql.go` | vt.delete.active_tasks.status | 🟡 declared, not yet executed |
