...
<!-- BEGIN GENERATED: config-keys manifest.refresh_interval -->
<!-- Generated by `make config-docs` from the code; do not edit. -->

| Key | Default | Config file | Flags | Description |
|---|---|---|---|---|
| `manifest.refresh_interval` | `5m` | set | `-lakehouse.manifest.refresh-interval` | How often the manifest is fully re-listed from S3. |
