...
<!-- BEGIN GENERATED: config-keys cache.memory_limit -->
<!-- Generated by `make config-docs` from the code; do not edit. -->

| Key | Default | Config file | Flags | Description |
|---|---|---|---|---|
| `cache.memory_limit` | `512MB` | set | `-lakehouse.cache.memory-mb` | The deprecated L1 in-memory cache budget, as a size string such as 512MB, used when memory_request and memory_limit_v2 are unset. |
...
<!-- BEGIN GENERATED: config-keys cache.disk_path cache.disk_limit cache.eviction_watermark -->
<!-- Generated by `make config-docs` from the code; do not edit. -->

| Key | Default | Config file | Flags | Description |
|---|---|---|---|---|
| `cache.disk_path` | `/data/lakehouse/cache` | set | `-lakehouse.cache.disk-path` | The L2 disk cache directory. |
| `cache.disk_limit` | `50GB` | set | `-lakehouse.cache.disk-max-mb` | The L2 disk cache size, as a size string such as 50GB. |
| `cache.eviction_watermark` | `0.8` | set |  | The fraction of disk_limit, in (0, 1], at which L2 eviction starts. |
...
<!-- BEGIN GENERATED: config-keys peer.auth_key peer.timeout peer.max_connections discovery.peer_headless_service discovery.peer_refresh_interval -->
<!-- Generated by `make config-docs` from the code; do not edit. -->
...
| `discovery.peer_refresh_interval` | `30s` | set |  | How often peer ring membership is refreshed. |
...
<!-- BEGIN GENERATED: config-keys cache.footer_max_items -->
<!-- Generated by `make config-docs` from the code; do not edit. -->

| Key | Default | Config file | Flags | Description |
|---|---|---|---|---|
| `cache.footer_max_items` | `0` | ignored |  | The upper bound on the parquet footer cache. |
...
<!-- BEGIN GENERATED: config-keys smart_cache.hot_access_threshold smart_cache.hot_window -->
<!-- Generated by `make config-docs` from the code; do not edit. -->

| Key | Default | Config file | Flags | Description |
|---|---|---|---|---|
| `smart_cache.hot_access_threshold` | `3` | set |  | The number of accesses within hot_window that marks an entry hot. |
| `smart_cache.hot_window` | `10m` | set |  | The window over which hot accesses are counted. |
...
<!-- BEGIN GENERATED: config-keys smart_cache.max_age smart_cache.query_grace_period -->
<!-- Generated by `make config-docs` from the code; do not edit. -->

| Key | Default | Config file | Flags | Description |
|---|---|---|---|---|
| `smart_cache.max_age` | `24h` | set |  | The maximum age of a cached entry. |
| `smart_cache.query_grace_period` | `5m` | set |  | How long entries stay pinned after their query ends. |
...
<!-- BEGIN GENERATED: config-keys smart_cache.snapshot_interval -->
<!-- Generated by `make config-docs` from the code; do not edit. -->

| Key | Default | Config file | Flags | Description |
|---|---|---|---|---|
| `smart_cache.snapshot_interval` | `1m` | set |  | How often cache metadata is persisted to disk. |
...
<!-- BEGIN GENERATED: config-keys prefetch.correlated prefetch.read_ahead_depth prefetch.max_concurrent prefetch.max_queue -->
<!-- Generated by `make config-docs` from the code; do not edit. -->

| Key | Default | Config file | Flags | Description |
|---|---|---|---|---|
| `prefetch.correlated` | `true` | enable-only |  | **Not read.** Enables correlated logs-to-traces prefetch by trace_id. |
| `prefetch.read_ahead_depth` | `2` | set |  | **Not read.** The number of partitions prefetched ahead of a sequential scan. |
| `prefetch.max_concurrent` | `8` | set |  | Caps concurrent prefetch downloads. |
| `prefetch.max_queue` | `128` | set |  | **Not read.** Caps pending prefetch tasks. |
...
<!-- BEGIN GENERATED: config-keys smart_cache.target_hours smart_cache.disk_limit_max smart_cache.ingestion_rate_hint -->
<!-- Generated by `make config-docs` from the code; do not edit. -->

| Key | Default | Config file | Flags | Description |
|---|---|---|---|---|
| `smart_cache.target_hours` | `24` | set |  | The number of hours of recent data the cache sizes itself to hold. |
| `smart_cache.disk_limit_max` | `100GB` | set |  | The deprecated smart-cache disk budget, as a size string, used when disk_request and disk_limit are unset. |
| `smart_cache.ingestion_rate_hint` | `""` | set |  | **Not read.** An ingestion rate such as 500MB that seeds cache sizing; empty detects it. |
